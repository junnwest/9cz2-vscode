...
# Auto-detects last completed or partial step and continues from there.
# Re-submit job-submit-beagle3.sbatch for each additional block.
#
# STEPS_PER_RUN: steps per submission (2 fs/step).
#   25,000,000 = 50 ns
# Adjust after first run based on observed GPU speed.

set -e

STEPS_PER_RUN=25000000
